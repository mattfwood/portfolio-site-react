...
const AboutSection = () => (
  <div className="about-section">
    ...
    <div className="about-body">
      ...
      <p>I'm a React convert, Node advocate and Javascript apologist. I believe in creating interactive frontend web experiences that are responsive and intuitive.</p>
